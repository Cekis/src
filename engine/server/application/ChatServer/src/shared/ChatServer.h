...
public:
	...
	static void       createRoom                (const NetworkId & id, const uint64_t sequence, const std::string & name, const bool isModerated, const bool isPublic, const std::string & title);
	static void       putSystemAvatarInRoom     (const std::string & roomName);
	static void       enterRoom                 (const NetworkId & id, const uint64_t sequence, const std::string & roomName);
	static void       enterRoom                 (const NetworkId & id, const uint64_t sequence, const unsigned int roomId);
	static void       enterRoom                 (const ChatAvatarId & id, const std::string & roomName, bool forceCreate, bool createPrivate);
	static void       sendInstantMessage        (const NetworkId & fromId, const uint64_t sequence, const ChatAvatarId & to, const Unicode::String & message, const Unicode::String & oob);
	...
	static void       leaveRoom                 (const NetworkId & id, const uint64_t sequence, const unsigned int roomId);
	...
	static void       sendRoomMessage           (const NetworkId & id, const uint64_t sequence, const unsigned int roomId, const Unicode::String & message, const Unicode::String & oob);
	...
	static void       queryRoom                 (const NetworkId & id, ConnectionServerConnection * connection, const uint64_t sequence, const std::string & roomName);
	...
	static void       sendPersistentMessage     (const NetworkId & fromId, const uint64_t sequence, const ChatAvatarId & to, const Unicode::String & subject, const Unicode::String & message, const Unicode::String & oob);
	...
	static void       requestPersistentMessage  (const NetworkId &id, const uint64_t sequence, const unsigned int messageId);
