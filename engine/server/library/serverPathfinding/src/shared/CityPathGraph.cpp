...
intptr_t CityPathGraph::getNeighborCode ( int whichNode ) const
{
	...
	for(int i = 0; i < edgeCount; i++)
	{
		...
		intptr_t neighborInt = reinterpret_cast<intptr_t>(neighbor);

		intptr_t mungedInt = neighborInt * 1295183;
